#By Jack W
#Special thanks to Jack C for help trouble shooting
'''
This was my summative project from grade 10


'''

from cmu_graphics import * #Imports all of the things you will need from cmu into vscode
...
cmu_graphics.run()  # vscode will tell you that 'cmu_graphics" is not defined but it still works and is needed for the code to run
